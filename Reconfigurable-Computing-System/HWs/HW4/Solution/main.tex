...
\usepackage{wrapfig}
\usepackage{capt-of}
\usepackage{subcaption}  % For creating subplots
\usepackage{caption}     % For custom captions
\usepackage{multicol}  % For multiple columns
\usepackage[table]{xcolor}  % For highlighting rows
...
\prof{\href{https://scholar.google.com/citations?user=qMmvqUwAAAAJ&hl=en}{\textcolor{black}{دکتر صاحب‌الزمانی}}}
