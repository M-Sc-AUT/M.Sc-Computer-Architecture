...
module cnn_dense_Pipeline_VITIS_LOOP_50_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] zext_ln50_fu_80_p1;
reg   [3:0] j_fu_36;
wire   [3:0] add_ln50_fu_74_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln50_fu_68_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln50_fu_68_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln50_fu_74_p2 = (ap_sig_allocacmp_j_1 + 4'd1);
...
assign dense_array_address0 = zext_ln50_fu_80_p1;

assign dense_to_softmax_streams_0_din = dense_array_q0;

assign icmp_ln50_fu_68_p2 = ((ap_sig_allocacmp_j_1 == 4'd10) ? 1'b1 : 1'b0);

assign zext_ln50_fu_80_p1 = ap_sig_allocacmp_j_1;

endmodule //cnn_dense_Pipeline_VITIS_LOOP_50_2
