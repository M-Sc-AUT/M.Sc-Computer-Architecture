...
entity cnn_dense_Pipeline_VITIS_LOOP_50_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of cnn_dense_Pipeline_VITIS_LOOP_50_2 is 
...
attribute shreg_extract : string;
    ...
    signal zext_ln50_fu_80_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal j_fu_36 : STD_LOGIC_VECTOR (3 downto 0) := "0000";
    signal add_ln50_fu_74_p2 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln50_fu_68_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    j_fu_36 <= add_ln50_fu_74_p2;
    ...
    add_ln50_fu_74_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j_1) + unsigned(ap_const_lv4_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln50_fu_68_p2)
    begin
        if (((icmp_ln50_fu_68_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    dense_array_address0 <= zext_ln50_fu_80_p1(4 - 1 downto 0);
    ...
    icmp_ln50_fu_68_p2 <= "1" when (ap_sig_allocacmp_j_1 = ap_const_lv4_A) else "0";
    zext_ln50_fu_80_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_j_1),64));
end behav;
