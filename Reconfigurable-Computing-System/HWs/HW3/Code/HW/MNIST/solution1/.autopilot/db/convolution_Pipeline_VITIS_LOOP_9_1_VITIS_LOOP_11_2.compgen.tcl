...
set id 5
set name convolution_mac_muladd_5ns_5ns_5ns_10_4_1
...
set InstName convolution_flow_control_loop_pipe_sequential_init_U
set CompName convolution_flow_control_loop_pipe_sequential_init
