# 1 "MNIST/src/random_number_gen.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MNIST/src/random_number_gen.cpp" 2
# 1 "MNIST/src/random_number_gen.h" 1
...
# 5 "MNIST/src/random_number_gen.h" 2

unsigned int pseudo_random(unsigned int seed, int load);
# 2 "MNIST/src/random_number_gen.cpp" 2
