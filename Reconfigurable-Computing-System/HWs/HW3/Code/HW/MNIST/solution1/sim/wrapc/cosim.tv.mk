...
$(ObjDir)/tb_convolution.cpp_pre.cpp.tb.o : tb_convolution.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling tb_convolution.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/convolution.cpp_pre.cpp.tb.o : convolution.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling convolution.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
