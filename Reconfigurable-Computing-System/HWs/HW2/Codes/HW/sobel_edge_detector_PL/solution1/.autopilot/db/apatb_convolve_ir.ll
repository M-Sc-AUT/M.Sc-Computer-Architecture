...
define void @apatb_convolve_ir([5 x i32]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="5" %x, [3 x i32]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="3" %kernel, [5 x i32]* noalias nocapture nonnull "fpga.decayed.dim.hint"="5" %output) local_unnamed_addr #0 {
entry:
