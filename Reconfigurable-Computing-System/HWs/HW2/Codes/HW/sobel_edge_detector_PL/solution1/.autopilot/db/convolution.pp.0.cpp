...
__attribute__((sdx_kernel("convolve", 0))) void convolve(int x[5][5], int kernel[3][3], int output[5][5])
{
#line 18 "/mnt/9636D17436D15639/University/CE-Github-Repository/M.Sc-Computer-Architecture/Reconfigurable-Computing-System/HWs/HW2/Codes/HW/sobel_edge_detector_PL/solution1/csynth.tcl"
...
# 7 "convolution.cpp"
    ...
    VITIS_LOOP_18_1: for (i = 1; i < 5 - 1; i++)
    {

        VITIS_LOOP_21_2: for (j = 1; j < 5 - 1; j++)
        {

            sum = 0;
            VITIS_LOOP_25_3: for (k = -1; k <= 1; k++)
            {

                VITIS_LOOP_28_4: for (l = -1; l <= 1; l++)
                {
