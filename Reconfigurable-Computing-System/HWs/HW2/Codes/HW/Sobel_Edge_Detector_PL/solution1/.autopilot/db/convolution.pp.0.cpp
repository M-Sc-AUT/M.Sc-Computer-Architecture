# 1 "Sobel_Edge_Detector_PL/src/convolution.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "Sobel_Edge_Detector_PL/src/convolution.cpp" 2
# 1 "/media/reza/_dev_sda1/Vitis_HLS/2023.2/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/math.h" 1 3
# 36 "/media/reza/_dev_sda1/Vitis_HLS/2023.2/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/math.h" 3
...
# 37 "/media/reza/_dev_sda1/Vitis_HLS/2023.2/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/math.h" 2 3
...
using std::tgamma;
using std::trunc;
# 2 "Sobel_Edge_Detector_PL/src/convolution.cpp" 2
# 1 "Sobel_Edge_Detector_PL/src/convolution.h" 1
...
# 2 "Sobel_Edge_Detector_PL/src/convolution.h" 2
# 3 "Sobel_Edge_Detector_PL/src/convolution.cpp" 2



__attribute__((sdx_kernel("convolve", 0))) void convolve(int x[128][128], int kernel[3][3], int output[128][128])
{
#line 25 "/mnt/9636D17436D15639/University/CE-Github-Repository/M.Sc-Computer-Architecture/Reconfigurable-Computing-System/HWs/HW2/Codes/HW/Sobel_Edge_Detector_PL/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=convolve
# 7 "Sobel_Edge_Detector_PL/src/convolution.cpp"

#line 7 "/mnt/9636D17436D15639/University/CE-Github-Repository/M.Sc-Computer-Architecture/Reconfigurable-Computing-System/HWs/HW2/Codes/HW/Sobel_Edge_Detector_PL/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=convolve
# 7 "Sobel_Edge_Detector_PL/src/convolution.cpp"
...
#pragma HLS INTERFACE s_axilite port=return bundle=control
 ...
 VITIS_LOOP_17_1: for (i = 0; i < 128; i++)
 {
  VITIS_LOOP_19_2: for (j = 0; j < 128; j++)
  {
#pragma HLS PIPELINE II=1
 output[i][j] = 0;
    ...
    VITIS_LOOP_27_3: for (i = 1; i < 128 - 1; i++)
    {
#pragma HLS LOOP_TRIPCOUNT min=1 max=128 -2
 VITIS_LOOP_30_4: for (j = 1; j < 128 - 1; j++)
        {
#pragma HLS PIPELINE II=1
 sum = 0;
            VITIS_LOOP_34_5: for (k = -1; k <= 1; k++)
            {
#pragma HLS UNROLL
 VITIS_LOOP_37_6: for (l = -1; l <= 1; l++)
                {
#pragma HLS UNROLL
 int a = x[i + k][j + l];
