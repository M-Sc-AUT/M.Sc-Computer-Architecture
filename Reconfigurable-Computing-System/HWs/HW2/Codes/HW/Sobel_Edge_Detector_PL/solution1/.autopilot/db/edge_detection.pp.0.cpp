# 1 "Sobel_Edge_Detector_PL/src/edge_detection.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "Sobel_Edge_Detector_PL/src/edge_detection.cpp" 2
# 1 "Sobel_Edge_Detector_PL/src/edge_detection.h" 1
...
# 2 "Sobel_Edge_Detector_PL/src/edge_detection.h" 2
# 2 "Sobel_Edge_Detector_PL/src/edge_detection.cpp" 2
...
using std::tgamma;
using std::trunc;
# 3 "Sobel_Edge_Detector_PL/src/edge_detection.cpp" 2



void edge_detector(int pre_x[128][128], int pre_y[128][128], unsigned char edge_out[128][128])
{
...
#pragma HLS INTERFACE s_axilite port=return bundle=control
 ...
 int i, j;
    ...
    VITIS_LOOP_18_1: for (i = 0; i < 128; i++)
    {
#pragma HLS LOOP_TRIPCOUNT min=1 max=128
 VITIS_LOOP_21_2: for (j = 0; j < 128; j++)
        {
#pragma HLS PIPELINE II=1
 int gx = pre_x[i][j];
    ...
    VITIS_LOOP_38_3: for (i = 0; i < 128; i++)
    {
#pragma HLS LOOP_TRIPCOUNT min=1 max=128
 VITIS_LOOP_41_4: for (j = 0; j < 128; j++)
        {
#pragma HLS PIPELINE II=1
