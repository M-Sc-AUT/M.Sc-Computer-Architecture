...
HD_PWD='C:/AUT/RCS/HW2/HW/Sobel_Edge_Detector_PS/Sobel_Edge_Detector_PS/Sobel_Edge_Detector_PS.runs/design_1_sobel_edge_detector_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_sobel_edge_detector_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_sobel_edge_detector_0_2.tcl
