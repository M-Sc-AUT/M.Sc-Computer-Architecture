...
def define_model() -> Sequential:
	...
	model.add(Conv2D(filters=conv_filter_num, kernel_size=conv_kernel_size, strides=stride_size,
				    activation="relu", padding="same", input_shape=(28, 28, 1), name="convolution_layer"))
	...
	model.add(Dense(64, activation='relu', name="dense_layer3"))
	model.add(Dense(10, activation="softmax", name="dense_layer4"))
