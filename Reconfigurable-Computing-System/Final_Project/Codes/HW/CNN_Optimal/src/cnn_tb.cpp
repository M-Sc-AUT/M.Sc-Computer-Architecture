...
int main()
{
	...
	int labels[N];
	if( 0 != read_labels("/mnt/9636D17436D15639/University/CE-Github-Repository/M.Sc-Computer-Architecture/Reconfigurable-Computing-System/Final_Project/Codes/HW/CNN_Optimal/src/Data/out.dat", labels) )
	{
