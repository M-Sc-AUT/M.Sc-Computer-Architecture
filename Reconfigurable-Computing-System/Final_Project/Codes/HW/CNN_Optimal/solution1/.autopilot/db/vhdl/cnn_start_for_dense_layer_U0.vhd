...
entity cnn_start_for_dense_layer_U0 is 
    generic (
...
architecture rtl of cnn_start_for_dense_layer_U0 is

    component cnn_start_for_dense_layer_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_cnn_start_for_dense_layer_U0_ShiftReg : cnn_start_for_dense_layer_U0_ShiftReg
    generic map (
...
entity cnn_start_for_dense_layer_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end cnn_start_for_dense_layer_U0_ShiftReg;

architecture rtl of cnn_start_for_dense_layer_U0_ShiftReg is
