...
# 2 "<built-in>" 2
# 1 "CNN_Optimal/src/cnn.cpp" 2
# 1 "CNN_Optimal/src/cnn.h" 1
...
# 4 "CNN_Optimal/src/cnn.h" 2



__attribute__((sdx_kernel("cnn", 0))) void cnn(fixed_point_t img_in[28][28], fixed_point_t pred[10]);
# 2 "CNN_Optimal/src/cnn.cpp" 2
# 1 "CNN_Optimal/src/utils.h" 1
...
# 5 "CNN_Optimal/src/utils.h" 2


void normalization_and_padding(fixed_point_t img_in[28][28], fixed_point_t img_out[(28 + (7 - 1))][(28 + (7 - 1))]);
# 3 "CNN_Optimal/src/cnn.cpp" 2
...
# 4 "CNN_Optimal/src/cnn.cpp" 2
# 1 "CNN_Optimal/src/pool.h" 1





void max_pooling_layer( hls::stream<fixed_point_t> conv_to_pool_streams[4],
                  hls::stream<fixed_point_t> pool_to_flat_streams[4] );
...
void flattening_layer( hls::stream<fixed_point_t> pool_to_flat_streams[4],
           hls::stream<fixed_point_t> flat_to_dense_stream[4] );
...
void dense_layer_soft_max( hls::stream<fixed_point_t> dense_to_softmax_streams[4],
         fixed_point_t prediction[10] );

void dense_layer( hls::stream<fixed_point_t> flat_to_dense_streams[4],
      hls::stream<fixed_point_t> dense_to_softmax_stream[4] );
...
void dataflow_section( fixed_point_t pad_img0 [(28 + (7 - 1))][(28 + (7 - 1))],
        fixed_point_t pad_img1 [(28 + (7 - 1))][(28 + (7 - 1))],
        fixed_point_t pad_img2 [(28 + (7 - 1))][(28 + (7 - 1))],
        fixed_point_t pad_img3 [(28 + (7 - 1))][(28 + (7 - 1))],
        fixed_point_t prediction [10] )
...
__attribute__((sdx_kernel("cnn", 0))) void cnn(fixed_point_t img_in[28][28], fixed_point_t prediction[10])
{
#line 27 "/mnt/9636D17436D15639/University/CE-Github-Repository/M.Sc-Computer-Architecture/Reconfigurable-Computing-System/Final_Project/Codes/HW/CNN_Optimal/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=cnn
# 66 "CNN_Optimal/src/cnn.cpp"

#line 7 "/mnt/9636D17436D15639/University/CE-Github-Repository/M.Sc-Computer-Architecture/Reconfigurable-Computing-System/Final_Project/Codes/HW/CNN_Optimal/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=cnn
# 66 "CNN_Optimal/src/cnn.cpp"



 fixed_point_t pad_img0[(28 + (7 - 1))][(28 + (7 - 1))] = { 0 };
 normalization_and_padding(img_in, pad_img0);
# 80 "CNN_Optimal/src/cnn.cpp"
 fixed_point_t pad_img1[(28 + (7 - 1))][(28 + (7 - 1))];
 fixed_point_t pad_img2[(28 + (7 - 1))][(28 + (7 - 1))];
 fixed_point_t pad_img3[(28 + (7 - 1))][(28 + (7 - 1))];
