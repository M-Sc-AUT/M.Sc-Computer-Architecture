set moduleName dense_Pipeline_VITIS_LOOP_49_2
set isTopModule 0
...
set C_modelName {dense_Pipeline_VITIS_LOOP_49_2}
...
set Spec2ImplPortList { 
	dense_array { ap_memory {  { dense_array_address0 mem_address 1 4 }  { dense_array_ce0 mem_ce 1 1 }  { dense_array_q0 in_data 0 32 } } }
