...
"SubInsts" : [
	{"Name" : "grp_cnn_Pipeline_1_fu_494","ID" : "1","Type" : "sequential",
		"SubLoops" : [
		{"Name" : "Loop 1","ID" : "2","Type" : "pipeline"},]},
	{"Name" : "grp_cnn_Pipeline_pad_for_rows_pad_for_cols_fu_554","ID" : "3","Type" : "sequential",
		"SubLoops" : [
		{"Name" : "pad_for_rows_pad_for_cols","ID" : "4","Type" : "pipeline"},]},
	{"Name" : "grp_cnn_Pipeline_clone_for_rows_clone_for_cols_fu_594","ID" : "5","Type" : "sequential",
		"SubLoops" : [
		{"Name" : "clone_for_rows_clone_for_cols","ID" : "6","Type" : "pipeline"},]},
	{"Name" : "grp_dataflow_section_fu_677","ID" : "7","Type" : "dataflow",
		"SubInsts" : [
		{"Name" : "convolutional_layer_U0","ID" : "8","Type" : "sequential",
			"SubInsts" : [
			{"Name" : "grp_convolution_fu_286","ID" : "9","Type" : "sequential",
				"SubLoops" : [
				{"Name" : "conv_for_rows_conv_for_cols_pool_for_rows_pool_for_cols","ID" : "10","Type" : "pipeline"},]},
			{"Name" : "grp_convolution_1_fu_348","ID" : "11","Type" : "sequential",
				"SubInsts" : [
				{"Name" : "grp_convolution_1_Pipeline_conv_for_rows_conv_for_cols_pool_for_rows_pool_for_cols_fu_780","ID" : "12","Type" : "sequential",
					"SubLoops" : [
					{"Name" : "conv_for_rows_conv_for_cols_pool_for_rows_pool_for_cols","ID" : "13","Type" : "pipeline"},]},]},
			{"Name" : "grp_convolution_1_fu_458","ID" : "14","Type" : "sequential",
				"SubInsts" : [
				{"Name" : "grp_convolution_1_Pipeline_conv_for_rows_conv_for_cols_pool_for_rows_pool_for_cols_fu_780","ID" : "15","Type" : "sequential",
					"SubLoops" : [
		...
		{"Name" : "max_pooling_layer_U0","ID" : "19","Type" : "sequential",
			"SubInsts" : [
			{"Name" : "grp_max_pooling_layer_Pipeline_pool_for_rows_pool_for_cols_fu_36","ID" : "20","Type" : "sequential",
				"SubLoops" : [
				{"Name" : "pool_for_rows_pool_for_cols","ID" : "21","Type" : "pipeline"},]},
			{"Name" : "grp_max_pooling_layer_Pipeline_pool_for_rows_pool_for_cols6_fu_44","ID" : "22","Type" : "sequential",
				"SubLoops" : [
				{"Name" : "pool_for_rows_pool_for_cols","ID" : "23","Type" : "pipeline"},]},
			{"Name" : "grp_max_pooling_layer_Pipeline_pool_for_rows_pool_for_cols7_fu_52","ID" : "24","Type" : "sequential",
				"SubLoops" : [
				{"Name" : "pool_for_rows_pool_for_cols","ID" : "25","Type" : "pipeline"},]},
			{"Name" : "grp_max_pooling_layer_Pipeline_pool_for_rows_pool_for_cols8_fu_60","ID" : "26","Type" : "sequential",
				"SubLoops" : [
