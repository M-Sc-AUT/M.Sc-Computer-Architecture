...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "cnn.autotvin.dat"
	set constFileTvOut       "cnn.autotvout.dat"
	set constFileHdlTvIn     "cnn.autohdltvin.dat"
	set constFileHdlTvOut    "cnn.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
