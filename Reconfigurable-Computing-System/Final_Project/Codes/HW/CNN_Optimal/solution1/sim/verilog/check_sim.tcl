...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.cnn.autotvin_img_in_0.dat"
         "c.cnn.autotvin_img_in_1.dat"
         "c.cnn.autotvin_img_in_2.dat"
         "c.cnn.autotvin_img_in_3.dat"
         "c.cnn.autotvin_prediction.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.cnn.autotvout_prediction.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
