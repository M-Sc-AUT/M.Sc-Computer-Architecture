...
wire    grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_dense_size_fu_36_ap_start;
wire    grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_dense_size_fu_36_ap_done;
wire    grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_dense_size_fu_36_ap_idle;
wire    grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_dense_size_fu_36_ap_ready;
wire    grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_dense_size_fu_36_dense_to_softmax_streams_0_read;
wire    grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_dense_size_fu_36_dense_to_softmax_streams_1_read;
wire    grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_dense_size_fu_36_dense_to_softmax_streams_2_read;
wire    grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_dense_size_fu_36_dense_to_softmax_streams_3_read;
...
wire    grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_digits_fu_53_ap_ready;
...
reg    grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_digits_fu_53_ap_start_reg;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 4'd1;
#0 grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_dense_size_fu_36_ap_start_reg = 1'b0;
#0 grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_digits_fu_53_ap_start_reg = 1'b0;
end

cnn_dense_layer_soft_max_Pipeline_dense_soft_max_for_dense_size grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_dense_size_fu_36(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_digits_fu_53_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_dense_size_fu_36_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1_ignore_call7))) begin
            grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_dense_size_fu_36_ap_start_reg <= 1'b1;
        end else if ((grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_dense_size_fu_36_ap_ready == 1'b1)) begin
            grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_dense_size_fu_36_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_digits_fu_53_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state3)) begin
            grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_digits_fu_53_ap_start_reg <= 1'b1;
        end else if ((grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_digits_fu_53_ap_ready == 1'b1)) begin
            grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_digits_fu_53_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if ((grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_dense_size_fu_36_ap_done == 1'b0)) begin
...
always @ (*) begin
    if ((grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_digits_fu_53_ap_done == 1'b0)) begin
...
always @ (*) begin
    if (((grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_digits_fu_53_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_dense_size_fu_36_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
...
assign grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_dense_size_fu_36_ap_start = grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_dense_size_fu_36_ap_start_reg;

assign grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_digits_fu_53_ap_start = grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_digits_fu_53_ap_start_reg;

assign prediction_address1 = grp_dense_layer_soft_max_Pipeline_dense_soft_max_for_digits_fu_53_prediction_address1;
