set moduleName dense_Pipeline_1
set isTopModule 0
...
set C_modelArgList {
	{ dense_array float 32 regular {array 10 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "dense_array", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set Spec2ImplPortList { 
	dense_array { ap_memory {  { dense_array_address0 mem_address 1 4 }  { dense_array_ce0 mem_ce 1 1 }  { dense_array_we0 mem_we 1 1 }  { dense_array_d0 mem_din 1 32 } } }
}
