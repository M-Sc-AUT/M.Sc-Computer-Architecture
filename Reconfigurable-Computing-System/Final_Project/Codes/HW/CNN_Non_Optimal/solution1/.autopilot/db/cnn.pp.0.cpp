...
# 2 "<built-in>" 2
# 1 "CNN_Non_Optimal/src/cnn.cpp" 2
# 1 "CNN_Non_Optimal/src/cnn.h" 1


# 1 "CNN_Non_Optimal/src/Headers/definitions.h" 1
# 4 "CNN_Non_Optimal/src/cnn.h" 2



__attribute__((sdx_kernel("cnn", 0))) void cnn(float img_in[28][28], float pred[10]);
# 2 "CNN_Non_Optimal/src/cnn.cpp" 2
# 1 "CNN_Non_Optimal/src/utils.h" 1
...
# 5 "CNN_Non_Optimal/src/utils.h" 2


void normalization_and_padding(float img_in[28][28], float img_out[(28 + (7 - 1))][(28 + (7 - 1))]);
# 3 "CNN_Non_Optimal/src/cnn.cpp" 2
# 1 "CNN_Non_Optimal/src/conv.h" 1
...
# 4 "CNN_Non_Optimal/src/cnn.cpp" 2
# 1 "CNN_Non_Optimal/src/pool.h" 1
...
# 5 "CNN_Non_Optimal/src/cnn.cpp" 2
# 1 "CNN_Non_Optimal/src/flat.h" 1
...
# 6 "CNN_Non_Optimal/src/cnn.cpp" 2
...
# 7 "CNN_Non_Optimal/src/cnn.cpp" 2
...
{
#line 26 "/mnt/9636D17436D15639/University/CE-Github-Repository/M.Sc-Computer-Architecture/Reconfigurable-Computing-System/Final_Project/Codes/HW/CNN_Non_Optimal/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=cnn
# 65 "CNN_Non_Optimal/src/cnn.cpp"



  float pad_img0 [(28 + (7 - 1))][(28 + (7 - 1))] = { 0 };
  normalization_and_padding(img_in, pad_img0);
# 79 "CNN_Non_Optimal/src/cnn.cpp"
  float pad_img1 [(28 + (7 - 1))][(28 + (7 - 1))];
  float pad_img2 [(28 + (7 - 1))][(28 + (7 - 1))];
  float pad_img3 [(28 + (7 - 1))][(28 + (7 - 1))];
