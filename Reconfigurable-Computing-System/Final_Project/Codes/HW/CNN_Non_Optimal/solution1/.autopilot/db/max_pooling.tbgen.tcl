...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fcmp_32ns_32ns_1_2_no_dsp_1_U400", "Parent" : "0"},
...
set Spec2ImplPortList { 
	conv_to_pool_streams_0 { ap_fifo {  { conv_to_pool_streams_0_dout fifo_data_in 0 32 }  { conv_to_pool_streams_0_empty_n fifo_status 0 1 }  { conv_to_pool_streams_0_read fifo_port_we 1 1 } } }
	pool_to_flat_streams_0 { ap_fifo {  { pool_to_flat_streams_0_din fifo_data_in 1 32 }  { pool_to_flat_streams_0_full_n fifo_status 0 1 }  { pool_to_flat_streams_0_write fifo_port_we 1 1 } } }
}
