...
set C_modelArgMapList {[ 
	{ "Name" : "dense_array", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "mul", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ dense_array_we0 sc_out sc_logic 1 signal 0 } 
	{ dense_array_d0 sc_out sc_lv 32 signal 0 } 
	{ dense_array_address1 sc_out sc_lv 4 signal 0 } 
	{ dense_array_ce1 sc_out sc_logic 1 signal 0 } 
	{ dense_array_q1 sc_in sc_lv 32 signal 0 } 
	{ flat_to_dense_streams_0_dout sc_in sc_lv 32 signal 1 } 
	{ flat_to_dense_streams_0_empty_n sc_in sc_logic 1 signal 1 } 
	{ flat_to_dense_streams_0_read sc_out sc_logic 1 signal 1 } 
	{ mul sc_in sc_lv 10 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mul", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "mul", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "11", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fadd_32ns_32ns_32_4_full_dsp_1_U412", "Parent" : "0"},
	{"ID" : "12", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fmul_32ns_32ns_32_4_max_dsp_1_U413", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1971", "Max" : "1971"}
	, {"Name" : "Interval", "Min" : "1971", "Max" : "1971"}
]}
