; ModuleID = '/mnt/9636D17436D15639/University/CE-Github-Repository/M.Sc-Computer-Architecture/Reconfigurable-Computing-System/Final_Project/Codes/HW/CNN_Non_Optimal/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call fastcc void @copy_in([28 x [28 x float]]* nonnull %0, [28 x [28 x float]]* nonnull align 512 %img_in_copy, [10 x float]* nonnull %1, [10 x float]* nonnull align 512 %prediction_copy)
  call void @apatb_cnn_hw([28 x [28 x float]]* %img_in_copy, [10 x float]* %prediction_copy)
  call void @copy_back([28 x [28 x float]]* %0, [28 x [28 x float]]* %img_in_copy, [10 x float]* %1, [10 x float]* %prediction_copy)
  ret void
}
