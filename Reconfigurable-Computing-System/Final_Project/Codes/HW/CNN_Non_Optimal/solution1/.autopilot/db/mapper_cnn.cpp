...
__xlx_prediction__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_prediction)[i]);
}
...
((Byte<4>*)__xlx_apatb_param_prediction)[i] = __xlx_prediction__tmp_vec[__xlx_offset_param_prediction+i];
}
}
