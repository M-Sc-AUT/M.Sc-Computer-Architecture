# 1 "CNN_Non_Optimal/src/pool.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 3 "CNN_Non_Optimal/src/pool.cpp" 2
