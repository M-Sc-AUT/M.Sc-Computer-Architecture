...
set name cnn_fexp_32ns_32ns_32_8_full_dsp_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler cnn_dataflow_section_Pipeline_dense_soft_max_for_dense_size_dense_biases_ROM_AUTObkb BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    id 440 \
    name dense_to_softmax_streams \
    type fifo \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_dense_to_softmax_streams \
    op interface \
    ports { dense_to_softmax_streams_dout { I 32 vector } dense_to_softmax_streams_empty_n { I 1 bit } dense_to_softmax_streams_read { O 1 bit } } \
} "
}
